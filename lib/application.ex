defmodule EmpleadosExAlbc.Application do
  alias EmpleadosExAlbc.Infrastructure.EntryPoint.ApiRest
  alias EmpleadosExAlbc.Config.{AppConfig, ConfigHolder}
  alias EmpleadosExAlbc.Utils.CertificatesAdmin
  alias EmpleadosExAlbc.Utils.CustomTelemetry
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: EmpleadosExAlbc.Supervisor]
