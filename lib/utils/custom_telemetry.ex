defmodule EmpleadosExAlbc.Utils.CustomTelemetry do
  alias EmpleadosExAlbc.Utils.DataTypeUtils
  import Telemetry.Metrics

  @service_name Application.compile_env!(:empleados_ex_albc, :custom_metrics_prefix_name)
  ...
  def custom_telemetry_events() do
    :telemetry.attach("empleados_ex_albc-plug-stop", [:empleados_ex_albc, :plug, :stop], &handle_custom_event/4, nil)
    :telemetry.attach("empleados_ex_albc-redis-stop", [:redix, :pipeline, :stop], &handle_custom_event/4, nil)
    :telemetry.attach("empleados_ex_albc-vm-memory", [:vm, :memory], &handle_custom_event/4, nil)
  ...
  def handle_custom_event([:empleados_ex_albc, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
